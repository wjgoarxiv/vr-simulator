...
const translations = {
  'en': {
    // Header
    appTitle: 'VR Simulator V2.1',
    appSubtitle: 'TQQQ Value Rebalancing Investment Simulator',
    ...
    initialTQQQShares: 'Initial TQQQ Shares',
    currentTQQQPrice: 'Current TQQQ Price ($)',
    ...
    sellTarget: 'Sell Target (-1 share)',
  ...
  'ko': {
    // Header
    appTitle: 'VR 시뮬레이터 V2.1',
    appSubtitle: 'TQQQ 밸류 리밸런싱 투자 시뮬레이터',
    writtenBy: '제작자',
    ...
    initialTQQQShares: '초기 TQQQ 보유 주식 수',
    currentTQQQPrice: '현재 TQQQ 가격 ($)',
    initialPool: '초기 예수금 ($)',
